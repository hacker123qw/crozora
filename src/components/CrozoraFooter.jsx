      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'rgba(148,163,184,0.7)' }}>
              A living ecosystem where ambitious builders, developers, and AI-native creators meet, collaborate, and turn ideas into reality.
            </p>
          ...
          {/* Ecosystem */}
          <div>
            <h4 className="text-white text-sm font-semibold mb-4">Ecosystem</h4>
            <ul className="space-y-3">
              {[
                ['Projects', '/dashboard/projects'],
                ['Discover Builders', '/dashboard/discover'],
                ['Build Rooms', '/dashboard/build-rooms'],
        ...
        <div className="mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderTop: '1px solid rgba(59,130,246,0.08)' }}>
          <p className="text-xs" style={{ color: 'rgba(100,116,139,0.5)' }}>
            Build together. Where builders and AI create together.
          </p>
          <Link to="/signup" className="text-xs text-blue-500 hover:text-blue-400 transition-colors">
            Enter the ecosystem →
          </Link>
        </div>
      </div>
